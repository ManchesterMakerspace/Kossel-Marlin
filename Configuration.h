...
#define STRING_CONFIG_H_AUTHOR "(jcrocholl, Kossel Model A V1)" // Who made the changes. ("Blomker" only edited the parametric values in the sketch. Author name is maintain as jcrocholl to indicate source of this sketch, and credit to where it is due)
...
#define CUSTOM_MENDEL_NAME "TKI Model A"
...
#define DELTA_DIAGONAL_ROD 288 // mm (215)

// Horizontal offset from middle of printer to smooth rod center.
#define DELTA_SMOOTH_ROD_OFFSET 211 // mm (137.0) 

// Horizontal offset of the universal joints on the end effector.
#define DELTA_EFFECTOR_OFFSET 20 // mm (19.9)

// Horizontal offset of the universal joints on the carriages.
#define DELTA_CARRIAGE_OFFSET 12 // mm (19.5)
...
#define MANUAL_Z_HOME_POS 257  // For delta: Distance between nozzle and print surface after homing.
